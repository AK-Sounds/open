(() => {
  ...
  // PRESERVED SONIC CHARACTER: Original FM Voice Generator
  ...
  // PRESERVED SONIC CHARACTER: Original playFmBell logic
  ...
  function start(limitSeconds = null) {
    ...
    // Each session generates a unique set of FM voices, like your original pre-gen logic
  ...
  function schedule() {
    ...
    start(dur); 
    document.getElementById('statusMessage').textContent = `Next in ${freq}m`;
