(() => {
    ...
    // Create a Master Gain node to prevent clicking when stopping
    ...
    function createReverb() {
        ...
        // Connect reverb to masterGain instead of destination
    ...
    function playFmBell(freq, duration, volume, startTime) {
        ...
        voices.forEach((voice) => {
            ...
            // Connect direct signal to masterGain
    ...
    function stopAll() {
        ...
        // Smoothly ramp down volume to avoid the "click"
        const now = audioContext.currentTime;
        masterGain.gain.setValueAtTime(masterGain.gain.value, now);
        masterGain.gain.linearRampToValueAtTime(0, now + 0.1);

        // Stop all nodes after the short fade-out
        setTimeout(() => {
